...
string powerplanGitHubAppName = "powerplanCopilotExtension";
    ...
    [FromBody] Request userRequest) =>
{
    ...
    var octokitClient =
        new GitHubClient(
            new Octokit.ProductHeaderValue(powerplanGitHubAppName))
        {
    ...
    userRequest.Messages.Insert(0, new Message
    {
        ...
        Content =
            ...
            "user messages as if you were Blackbeard the Pirate who is also a project and fixed asset accountant."
    });
